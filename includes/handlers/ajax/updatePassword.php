...
// use encrypted version to check to see if matches current password
$oldMd5 = md5($oldPassword);

// select all where current users equal current username
...
if (preg_match('/[^A-Za-z0-9]/', $newPassword1)) {
	echo "Your password must only contain letters and/or all numbers";
} 
